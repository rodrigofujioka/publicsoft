...
var JobsViewComponent = (function () {
    function JobsViewComponent(httpService, router) {
    ...
    JobsViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.router.params.subscribe(function (params) {
            _this.view(params.id);
        });
    };
    JobsViewComponent.prototype.view = function (id) {
        var _this = this;
...
exports.JobsViewComponent = JobsViewComponent;
//# sourceMappingURL=jobs-view.component.js.map